...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
  ...
  Future updateEmail({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        '7eq6rgps' /* Email change confirmation sent... */,
      ))),
    );
  }
  ...
  Future resetPassword({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(FFLocalizations.of(context).getText(
        'l2pgiure' /* Password reset email sent ! */,
      ))),
    );
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      final authUser = user == null ? null : TradesemGitHubSupabaseUser(user);
      ...
      final errorMsg = e.message.contains('User already registered') ?? false
          ? FFLocalizations.of(context).getText(
              '67as89gn' /* Email already in use by anothe... */,
            )
